...
class buy_controller2 extends GetxController{
  ...
  Map<String, dynamic>? cart_products = Map();
  Map<String, String> product_selected_map= Map();
  List dstrct_lst=[];
  RxBool is_account_balance_selected = false.obs;
  RxString address = "".obs, refer_code = "".obs,total_price='0'.obs,
  account_balance='0'.obs,delivery_fee='0'.obs,off_on_refer_buyer='0'.obs,off_on_refer_seller='0'.obs
  ,district=''.obs,division=''.obs,delivery_charge='0'.obs,weight='0'.obs,item_price='0'.obs,
      product_available_quantity='0'.obs;


  Future<void> get_product_data(product_selected_map) async {
    address.value = ""; refer_code.value = "";total_price.value='0';
    ...
    cart_products!.clear();
    this.product_selected_map=product_selected_map;
    ...
    await products_docference.doc(product_selected_map["product_database_id"]).get().then((doc) async{
      if(doc.exists){
        cart_products=await doc.data();
      }
    }).then((value) {
      ...
      return Obx(
                  ...
                  Material(
                    ...
                    child: InkWell(
                      borderRadius: BorderRadius.circular(6),
                      onTap: () {
                        Get.to(()=>brands_shops_home_page(brand_id: cart_products!["brand_id"]));
                      },
                      child: Ink(
                            ...
                            Expanded(
                              ...
                              child: Row(children: [
                                Stack(
                                  ...
                                  children: [
                                    CachedNetworkImage(
                                      imageUrl:cart_products!["brand_icon"],
                                    ...
                                    Visibility(
                                      visible: cart_products!["brand_verified"] ==
                                          "verified"
                                          ? true
                                          : false,
                                      child: Container(
                                ...
                                Expanded(
                                  child: Text(cart_products!["brand_name"],
                                    maxLines: 1,
                                ...
                                Text.rich(
                                  ...
                                  TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text:"${int.parse(weight.value)*int.parse(delivery_charge.value)}",
                                        style: TextStyle(fontSize: 14,color: darkFontGreyColor,fontWeight: FontWeight.w500),),
                                    ],
                                  ),
                                ),
                  ...
                  Material(
                        ...
                        child: InkWell(
                          borderRadius: BorderRadius.circular(6),
                          onTap: () {
                            Get.to(()=> product_details_page(
                                product_id: product_selected_map["product_database_id"]));
                          },
                          child: Ink(
                            ...
                            child:Stack(
                              children: [
                                Align(
                                  ...
                                  child: Row(children: [
                                    CachedNetworkImage(
                                      imageUrl:cart_products!["product_first_img"],
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          7.heightBox,
                                          Visibility(
                                            visible: product_selected_map
                                            ["selected_size"]==""?false:true,
                                            child: Text(
                                              "Size : ${product_selected_map
                                              ["selected_size"]}",
                                              style: TextStyle(
                                                  color: darkFontGreyColor,
                                                  fontSize: 14),
                                          ...
                                          Visibility(
                                            ...
                                            child: Row(children: [
                                              ...
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  borderRadius: BorderRadius.circular(6),
                                                  color: hexColor(product_selected_map
                                          ...
                                          Visibility(
                                            ...
                                            child: Text(
                                              "Variation : ${product_selected_map
                                              ["selected_variation"]}",
                                              style: TextStyle(
                                                  color: darkFontGreyColor,
                                                  fontSize: 14),
                                          ...
                                          Text.rich(
                                            ...
                                            TextSpan(
                                              children: [
                                                ...
                                                TextSpan(
                                                  text:cart_products!["off_percent"]=='0'?'':
                                                  "   ${cart_products!["off_percent"]}% off",
                                ...
                                Align(
                                  alignment: Alignment.centerRight,
                                  child: Text(
                                    item_storage(product_selected_map,cart_products),
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                    style: TextStyle(
                                        fontSize: 14,
                                        color: darkFontGreyColor,
                                        fontWeight: FontWeight.w500),
                                  ).box.margin(EdgeInsets.only(left: 5,right: 5,top: 90)).make(),
                                )
                              ],
                            ),
  ...
  item_price_calculation(){
    if(product_selected_map["selected_variation"]!=''){
      List l=cart_products!["liquid_ml_list"];
      int count=0;
      for(int i=0;i<l.length;i++){
        if(l[i]==product_selected_map["selected_variation"]!){
          if(int.parse(cart_products!["liquid_quantity_list"][i])>=
              int.parse(product_selected_map["product_quantity"]!)){
            item_price.value= "${((int.parse(cart_products!["liquid_ml_price_list"][i])-
                (((int.parse(cart_products!["brand_offer"])+int.parse(cart_products!["off_percent"]))
                    *int.parse(cart_products!["liquid_ml_price_list"][i]))/100
                ))* int.parse(product_selected_map["product_quantity"]!)).toStringAsFixed(0)}";
            count++;
            break;
          }
          else if(int.parse(cart_products!["liquid_quantity_list"][i])<
              int.parse(product_selected_map["product_quantity"]!)){
            item_price.value= "${((int.parse(cart_products!["liquid_ml_price_list"][i])-
                (((int.parse(cart_products!["brand_offer"])+int.parse(cart_products!["off_percent"]))
                    *int.parse(cart_products!["liquid_ml_price_list"][i]))/100
                ))* int.parse(cart_products!["liquid_quantity_list"][i])).toStringAsFixed(0)}";
            count++;
            break;
          }
        }
      }
      if(count==0)item_price.value= "0";
    }else{
      item_price.value= "${((int.parse(cart_products!["final_price"])-
          ((int.parse(cart_products!["brand_offer"])*int.parse(cart_products!["final_price"]))/100)
      )* int.parse(product_selected_map["product_quantity"]!)).toStringAsFixed(0)}";
    }
  }

  item_storage(cart,products){
    String quantity=available_item(cart,products);
    final splitted = quantity.split(' ');
    product_available_quantity.value=(splitted.last=='Available'?'0':splitted.last);
    return quantity;
  }
  ...
  product_weight_calculation(){
    weight.value='0';
        int cart_quantity=int.parse(product_selected_map["product_quantity"]!);
        if(product_selected_map["selected_variation"]!=''){
          List l= cart_products!["liquid_ml_list"];
          for(int j=0;j<l.length;j++){
            if(l[j]==product_selected_map["selected_variation"]){
              if(int.parse(cart_products!["liquid_quantity_list"][j])>=cart_quantity){
                weight.value= "${(int.parse(weight.value)+
                    (int.parse(cart_products!["liquid_weight_list"][j])*
                        cart_quantity)).toStringAsFixed(0)}";
              }
              else if(int.parse(cart_products!["liquid_quantity_list"][j])<cart_quantity){
                weight.value= "${(int.parse(weight.value)+
                    (int.parse(cart_products!["liquid_weight_list"][j])*
                        cart_products!["liquid_quantity_list"][j])).toStringAsFixed(0)}";
              }
            }
          }
        }
          ...
          weight.value= "${(int.parse(weight.value)+
              (int.parse(cart_products!["weight_per_kg"])*cart_quantity)).toStringAsFixed(0)}";
        }
      weight.value="${(int.parse(weight.value)/1000).ceil().toStringAsFixed(0)}";
  }
  ...
  total_price_calculator(){
    ...
    account_balance.value="${int.parse(item_price.value)>int.parse(account_balance.value)?
    int.parse(account_balance.value).toStringAsFixed(0):int.parse(item_price.value)}";

    off_on_refer_buyer.value="${refer_code.value.length>0?((int.parse(item_price.value)
        *int.parse(settingController.setting_list["off_customer"]))/100).toStringAsFixed(0):"0"}";

    off_on_refer_seller.value="${refer_code.value.length>0?((int.parse(item_price.value)
        *int.parse(settingController.setting_list["off_seller"]))/100).toStringAsFixed(0):"0"}";

    if(refer_code.value.length>0){
      account_balance.value="${(int.parse(item_price.value)-int.parse(off_on_refer_buyer.value))
          >int.parse(account_balance.value)?
      int.parse(account_balance.value).toStringAsFixed(0):(int.parse(item_price.value)-int.parse(off_on_refer_buyer.value)).toStringAsFixed(0)}";
    }

    delivery_fee.value=(int.parse(weight.value)*int.parse(delivery_charge.value)).toStringAsFixed(0);

    total_price.value=(int.parse(item_price.value)+int.parse(delivery_fee.value)
        -int.parse(account_balance.value)-int.parse(off_on_refer_buyer.value)).toStringAsFixed(0);
  ...
  Future<void> check_order_validation(context,payment_complete)async{
    if(refer_code.value!=drawerController.pref_info["referral_code"]){
      ...
      if((refer_code.value!='' && refer_code_user!=0) ||
        ...
        bool is_ok=true;
            if((int.parse(product_selected_map["product_quantity"]!)<=int.parse( cart_products!["product_buying_limit"]))
                ||  cart_products!["product_buying_limit"]=='0'
            ){
              await orders_docference.where("customer_database_id",isEqualTo: drawerController.pref_userId.value)
                  .where("product_database_id",isEqualTo: product_selected_map["product_database_id"]).get().then((doc){
                if(doc.size>0){
                  int total_bought=0;
                  for(var val in doc.docs)total_bought=total_bought+int.parse(val.get("product_quantity"));
                  total_bought=int.parse(product_available_quantity.value)+total_bought;
                  if(total_bought > int.parse(cart_products!["product_buying_limit"])
                      &&  cart_products!["product_buying_limit"]!='0'){
                    is_ok=false;
                    show_snackbar(context,"You exceeded the limit of '${ cart_products!["product_title"]}' this product",whiteColor,Colors.red);
                  }
                }
              });
            }
              ...
              show_snackbar(context,"${cants_buy_more_txt}"
                  "${cart_products!["product_buying_limit"]} items of '"
                  "${cart_products!["product_title"]}' this product",whiteColor,Colors.red);
            }
        if(is_ok){
  ...
  Future<void> place_order(payment_complete) async {
    ...
    order_info = {
      ...
      "total_product_price": total_price.value,
    ...
    batch.set(ordringodocRef,order_info);
        ...
        order_data={
          ...
          "product_database_id":product_selected_map["product_database_id"]!,
          "product_given_id":product_selected_map["product_given_id"]!,
          "product_image":cart_products!["product_first_img"],
          "product_title":cart_products!["product_title"],
          "product_price":item_price.value,
          "product_color":product_selected_map["selected_color"]==''?
          product_selected_map["selected_size_color"]!:product_selected_map["selected_color"]!,
          "product_size":product_selected_map["selected_size"]!,
          "product_variation":product_selected_map["selected_variation"]!,
          "product_quantity":product_available_quantity.value,

          "shop_database_id":cart_products!["brand_id"],
          "shop_name":cart_products!["brand_name"],
          "shop_icon":cart_products!["brand_icon"],
          "shop_division":cart_products!["brand_division"].toString(),
          "shop_district":cart_products!["brand_district"].toString(),
          "shop_full_address":cart_products!["brand_full_address"].toString(),
        ...
        final prdctDocRef = await products_docference.doc(product_selected_map["product_database_id"]);
        if(product_selected_map["selected_size"]!=''){
          final snapshot = await prdctDocRef.get();
          List l=snapshot.get("color_selected_list${product_selected_map["selected_size"]!}");
          List l2=snapshot.get("size_color_quantity_list${product_selected_map["selected_size"]!}");
          for(int j=0;j<=l.length;j++){
            if(l[j]==product_selected_map["selected_size_color"]){
              l2[j]=(int.parse(l2[j])-int.parse(product_available_quantity.value)).toString();
              break;
            }
          }
          String total_quantity=(int.parse(snapshot.get("quantity"))
              -int.parse(product_available_quantity.value)).toString();
          batch.update(prdctDocRef, {"size_color_quantity_list${product_selected_map["selected_size"]!}"
              : l2,"quantity":total_quantity});
        }
        else if(product_selected_map["selected_color"]!=''){
            final snapshot = await prdctDocRef.get();
            List l=snapshot.get("color_selected_list");
            List l2=snapshot.get("color_quantity_list");
            for(int j=0;j<=l.length;j++){
              if(l[j]==product_selected_map["selected_color"]){
                l2[j]=(int.parse(l2[j])-int.parse(product_available_quantity.value)).toString();
                break;
              }
            }
        ...
        else if(product_selected_map["selected_variation"]!=''){
            final snapshot = await prdctDocRef.get();
