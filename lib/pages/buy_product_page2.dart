...
import '../controllers/buy_controller2.dart';
import '../controllers/drawer_controller.dart';
import '../shapes/bar_with_back_button.dart';

class buy_product_page2 extends StatefulWidget {
  final Map<String, String> product_selected_map;
  const buy_product_page2({ Key? key,required this.product_selected_map }) : super(key: key);
  @override
  State<buy_product_page2> createState() => _buy_product2_pageState();
}

class _buy_product2_pageState extends State<buy_product_page2> {
  final buyController = Get.put(buy_controller2());
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                "${buyController.item_price.value}",
                                style: TextStyle(
                                    color: darkFontGreyColor,
                                    fontSize: 14, fontWeight: FontWeight.bold),
                              ),
  ...
  fetch_data() async {
    await Future.delayed(Duration(milliseconds: 200), () async {
      buyController.get_product_data(widget.product_selected_map);
    });
  }
}
